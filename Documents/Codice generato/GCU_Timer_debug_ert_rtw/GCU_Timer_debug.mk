###########################################################################
## Makefile generated for Simulink model 'GCU_Timer_debug'. 
## 
## Makefile     : GCU_Timer_debug.mk
## Generated on : Mon Apr 01 11:12:37 2019
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/GCU_Timer_debug.exe
...
MODELREF_LINK_RSPFILE_NAME = GCU_Timer_debug_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = GCU_Timer_debug_ref.rsp
CMD_FILE                  = GCU_Timer_debug.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/GCU_Timer_debug.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/GCU_Timer_debug_ert_rtw -IC:/Users/SIMONE/DOCUME~1/PROGRA~1/git/GCU-SI~1/Models/DEBUGS~1 -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=GCU_Timer_debug -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/GCU_Timer_debug_ert_rtw/GCU_Timer_debug.c $(START_DIR)/GCU_Timer_debug_ert_rtw/GCU_Timer_debug_data.c

MAIN_SRC = $(START_DIR)/GCU_Timer_debug_ert_rtw/ert_main.c
...
OBJS = GCU_Timer_debug.obj GCU_Timer_debug_data.obj
...
%.obj : $(START_DIR)/GCU_Timer_debug_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/GCU_Timer_debug_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
