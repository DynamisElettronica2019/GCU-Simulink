###########################################################################
## Makefile generated for Simulink model 'GCU_CAN'. 
## 
## Makefile     : GCU_CAN.mk
## Generated on : Sat Feb 16 15:40:38 2019
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: ./GCU_CAN_rtwlib.lib
...
MODELREF_LINK_RSPFILE_NAME = GCU_CAN_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ../../..
MODELREF_LINK_RSPFILE     = GCU_CAN_ref.rsp
CMD_FILE                  = GCU_CAN.rsp
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/slprj/ert/GCU_CAN -IC:/Users/SIMONE/DOCUME~1/PROGRA~1/GCUMOD~1/Models -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils
...
DEFINES_STANDARD = -DMODEL=GCU_CAN -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/GCU_CAN/GCU_CAN.c
...
%.obj : $(START_DIR)/slprj/ert/GCU_CAN/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/GCU_CAN/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
