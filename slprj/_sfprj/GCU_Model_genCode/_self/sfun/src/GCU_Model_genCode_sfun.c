  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(aiChksum, "gSbrr2YYdzUcgfCE8J5ANB") == 0) {
     ...
     case 2:
      {
        if (strcmp(aiChksum, "i6kAtGQ1Q9STkEKnnEYG2G") == 0) {
     ...
     case 8:
      {
        if (strcmp(aiChksum, "uKibM1b6aqbpLgCtljMYwD") == 0) {
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(instanceChksum, "s7yLqT8wU5qjb8gU2O3nbZF") == 0) {
     ...
     case 2:
      {
        if (strcmp(instanceChksum, "sRk6Ij7pcXaQwNOO26aZrbD") == 0) {
          extern const mxArray
     ...
     case 8:
      {
        if (strcmp(instanceChksum, "s9ms2kOe6bkYLWfyAlF3M7D") == 0) {
          extern const mxArray
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "s7yLqT8wU5qjb8gU2O3nbZF") == 0) {
     ...
     case 2:
      {
        if (strcmp(tpChksum, "sRk6Ij7pcXaQwNOO26aZrbD") == 0) {
     ...
     case 8:
      {
        if (strcmp(tpChksum, "s9ms2kOe6bkYLWfyAlF3M7D") == 0) {
  ...
  debugInstance)
{
  _GCU_Model_genCodeMachineNumber_ = sf_debug_initialize_machine(debugInstance,
    "GCU_Model_genCode","sfun",0,8,0,0,0);
