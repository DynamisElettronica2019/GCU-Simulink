  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(aiChksum, "IGAbwDaUgKb4LJNUduowwH") == 0) {
     ...
     case 2:
      {
        if (strcmp(aiChksum, "3n3NqJK4AfSy3eCenpWENF") == 0) {
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(instanceChksum, "s1I9TEwLFsAhgr5m7qOUmNC") == 0) {
     ...
     case 2:
      {
        if (strcmp(instanceChksum, "swuvFPdyGGLOvJ23FS9Lc6C") == 0) {
          extern const mxArray
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "s1I9TEwLFsAhgr5m7qOUmNC") == 0) {
     ...
     case 2:
      {
        if (strcmp(tpChksum, "swuvFPdyGGLOvJ23FS9Lc6C") == 0) {
  ...
  debugInstance)
{
  _GCU_Model_genCodeMachineNumber_ = sf_debug_initialize_machine(debugInstance,
    "GCU_Model_genCode","sfun",0,4,0,0,0);
