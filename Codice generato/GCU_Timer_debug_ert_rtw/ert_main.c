...
#include "GCU_Timer_debug.h"           /* Model's header file */
#include "rtwtypes.h"
...
void rt_OneStep(void)
{
  ...
  static int_T taskCounter[3] = { 0, 0, 4 };
  ...
  for (i = 1; i < 3; i++) {
    ...
    if (eventFlags[i]) {
      ...
      switch (i) {
       case 1 :
        GCU_Timer_debug_step1();

        /* Get model outputs here */
        break;

       case 2 :
        GCU_Timer_debug_step2();
