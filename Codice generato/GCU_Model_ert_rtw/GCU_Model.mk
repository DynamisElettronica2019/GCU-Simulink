###########################################################################
## Makefile generated for Simulink model 'GCU_Model'. 
## 
## Makefile     : GCU_Model.mk
## Generated on : Mon Feb 18 22:03:45 2019
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/GCU_Model.exe
...
MODELREF_LINK_RSPFILE_NAME = GCU_Model_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = GCU_Model_ref.rsp
CMD_FILE                  = GCU_Model.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/GCU_Model.exe
...
INCLUDES_BUILDINFO = -I./referenced_model_includes -I$(START_DIR) -I$(START_DIR)/GCU_Model_ert_rtw -IC:/Users/SIMONE/DOCUME~1/PROGRA~1/GCUMOD~1/Models -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils
...
DEFINES_STANDARD = -DMODEL=GCU_Model -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/GCU_Model_ert_rtw/GCU_Model.c

MAIN_SRC = $(START_DIR)/GCU_Model_ert_rtw/ert_main.c
...
MODELREF_LIBS = ./GCU_CAN_rtwlib.lib ./GCU_timer_rtwlib.lib
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(MODELREF_LIBS) $(LIBS) $(MAIN_OBJ)
	...
	$(LD) $(LDFLAGS) -o $(PRODUCT) @$(CMD_FILE) -Wl,--start-group @$(MODELREF_LINK_RSPFILE) -Wl,--end-group $(LIBS) $(SYSTEM_LIBS) $(TOOLCHAIN_LIBS)
...
%.obj : C:/Users/SIMONE/DOCUME~1/PROGRA~1/GCUMOD~1/LIBRAR~1/CANLIB~1/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : C:/Users/SIMONE/DOCUME~1/PROGRA~1/GCUMOD~1/LIBRAR~1/CANLIB~1/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.obj : $(START_DIR)/GCU_Model_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/GCU_Model_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
