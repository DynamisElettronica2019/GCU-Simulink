...
typedef struct {
  ...
  uint16_T autoXCounter_o3;            /* '<S5>/GCULogic' */
  ...
  uint8_T is_ACTIVE_cg;                /* '<S5>/GCULogic' */
  ...
  uint8_T is_ACTIVE_ky;                /* '<S5>/GCULogic' */
