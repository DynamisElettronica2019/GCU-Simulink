...
typedef struct {
  ...
  uint16_T TmpRTBAtGCU_timerInport15[2];
  ...
  volatile uint16_T TmpRTBAtGCU_timerInport15_Buffe[4];/* synthesized block */
  ...
  volatile int8_T TmpRTBAtGCU_timerInport15_Activ;/* synthesized block */
 ...
 * Block '<S10>/Cast' : Unused code path elimination
