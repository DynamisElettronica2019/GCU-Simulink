...
typedef struct {
  uint8_T GearMotorTurnRight_o1;       /* '<S86>/GearMotor Turn Right' */
  uint8_T GearMotorTurnRight_o2;       /* '<S86>/GearMotor Turn Right' */
  uint8_T GearMotorTurnRight_o3;       /* '<S86>/GearMotor Turn Right' */
} DW_Gearmotor_turnRight;

/* Block signals and states (default storage) for system '<S45>/Gearmotor_brake' */
typedef struct {
  uint8_T GearMotorBrake_o1;           /* '<S83>/GearMotor Brake' */
  uint8_T GearMotorBrake_o2;           /* '<S83>/GearMotor Brake' */
  uint8_T GearMotorBrake_o3;           /* '<S83>/GearMotor Brake' */
} DW_Gearmotor_brake;
...
typedef struct {
  ...
  uint8_T GearMotorTurnLeft_o1;        /* '<S85>/GearMotor Turn Left' */
  uint8_T GearMotorTurnLeft_o2;        /* '<S85>/GearMotor Turn Left' */
  uint8_T GearMotorTurnLeft_o3;        /* '<S85>/GearMotor Turn Left' */
  uint8_T GearMotorRelease;            /* '<S84>/GearMotor Release' */
 ...
 * '<S76>'  : 'GCU_Model_genCode/GCU_timer/GCULogic/MODES.ACCELERATION_PID.LAUNCH2.ACTIVE.pidControl/Discrete PID Controller'
 * '<S77>'  : 'GCU_Model_genCode/GCU_timer/GCULogic/MODES.ACCELERATION_PID.LAUNCH3.ACTIVE.pidControl/Discrete PID Controller'
 * '<S78>'  : 'GCU_Model_genCode/GCU_timer/GCULogic/MODES.ACCELERATION_PID.LAUNCH4.ACTIVE.pidControl/Discrete PID Controller'
 * '<S79>'  : 'GCU_Model_genCode/GCU_timer/GCULogic/MODES.ACCELERATION_PID.LAUNCH5.ACTIVE.pidControl/Discrete PID Controller'
 * '<S80>'  : 'GCU_Model_genCode/GCU_timer/GCULogic/MODES.ACCELERATION_PID.LAUNCH6.ACTIVE.pidControl/PID Soft'
 * '<S81>'  : 'GCU_Model_genCode/GCU_timer/GCULogic/MODES.ACCELERATION_PID.LAUNCH7.ACTIVE.pidControl/PID Aggressive'
 * '<S82>'  : 'GCU_Model_genCode/GCU_timer/GCULogic/MODES.ACCELERATION_PID.LAUNCH8.ACTIVE.pidControl/PID Aggressive'
 * '<S83>'  : 'GCU_Model_genCode/GCU_timer/GearMotor1/Gearmotor_brake'
 * '<S84>'  : 'GCU_Model_genCode/GCU_timer/GearMotor1/Gearmotor_release'
 * '<S85>'  : 'GCU_Model_genCode/GCU_timer/GearMotor1/Gearmotor_turnLeft'
 * '<S86>'  : 'GCU_Model_genCode/GCU_timer/GearMotor1/Gearmotor_turnRight'
