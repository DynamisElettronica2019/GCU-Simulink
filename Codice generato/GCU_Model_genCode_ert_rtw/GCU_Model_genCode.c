...
#define IN_DEFAULT_a                   ((uint8_T)1U)
...
#define IN_Default_k                   ((uint8_T)2U)
  ...
  ZCE_MODESACCELERATION_PIDLAUN_j *localZCE)
{
   ...
   *  Sum: '<S106>/Diff'
   */
  rtb_SignPreIntegrator = (rtb_IOut * rtb_Merge1 + Integrator) + (rtb_TSamp -
    localDW->UD_DSTATE);
  ...
  if (rtb_SignPreIntegrator > 17.0) {
    ...
    rtb_Merge1 = rtb_SignPreIntegrator;
  }
  ...
  *rty_clutchVal = 17.0 - rtb_Merge1;
  ...
  /* Gain: '<S105>/ZeroGain' */
  rtb_Merge1 = 0.0 * rtb_SignPreIntegrator;
  ...
  rtb_NotEqual = (rtb_Merge1 != rtb_SignPreIntegrator);
     ...
     case IN_DOWN_REBOUND:
      if (rtDW.ticksCounter == 1) {
        ...
        if (rtDW.clutchCurrVal < 81) {
          ...
          if (rtDW.is_DOWN_BRAKE != IN_Default_k) {
            rtDW.is_DOWN_BRAKE = IN_Default_k;
    ...
    if ((rtDW.sfEvent == event_GearshiftUp) && ((rtDW.RateTransition36[6] < 5) ||
      ...
      if (rtDW.sfEvent == event_GearshiftDown) {
        ...
        if ((rtDW.is_NEUTRAL_STATE == IN_SET_NEUTRAL) && (rtDW.clutchCurrVal <=
          ...
          rtDW.is_DOWN_START = IN_Default_k;
        }
      }
    }
    break;
     ...
     case IN_UP_START:
      if (rtDW.ticksCounter == 1) {
        ...
        if (!(rtDW.is_NEUTRAL_STATE == IN_SET_NEUTRAL)) {
          ...
          if (rtDW.is_UP_PUSH != IN_Default_k) {
            rtDW.is_UP_PUSH = IN_Default_k;
...
static void ACCELERATION(void)
{
  ...
  if ((rtDW.RateTransition8[0] != rtDW.lastModeCom[0]) && (rtDW.RateTransition8
    ...
    if (rtDW.RateTransition8[1] == ENDURANCE_MODE) {
      ...
      if (rtDW.is_ACCELERATION_PID != IN_DEFAULT_a) {
        rtDW.is_ACCELERATION_PID = IN_DEFAULT_a;
    ...
    switch (rtDW.RateTransition1_b) {
     ...
     case 2:
      ...
      if (rtDW.is_ACTIVE_n != IN_START) {
        ...
        rtDW.stateFb = (uint16_T)AUTOX_READY;
        rtDW.autoXCounter_gp = AUTOX_WORK_RATE_ms;
     ...
     case 5:
      ...
      if (rtDW.is_ACTIVE_d != IN_START) {
        ...
        rtDW.stateFb = (uint16_T)AUTOX_READY;
        rtDW.autoXCounter_dc = AUTOX_WORK_RATE_ms;
     ...
     case 6:
      ...
      if (rtDW.is_ACTIVE_gc != IN_START) {
        rtDW.is_ACTIVE_gc = IN_START;
        rtDW.stateFb = (uint16_T)AUTOX_READY;
     ...
     case 8:
      ...
      if (rtDW.is_ACTIVE_m != IN_START) {
        ...
        rtDW.stateFb = (uint16_T)AUTOX_READY;
        rtDW.autoXCounter_fg = AUTOX_WORK_RATE_ms;
      ...
      switch (rtDW.is_ACTIVE_n) {
       case IN_READY:
        if (rtDW.autoXCounter_gp <= 1) {
          ...
          tmp = rtDW.autoXCounter_gp - 1;
          if (tmp < 0) {
            tmp = 0;
          }

          rtDW.autoXCounter_gp = (uint16_T)tmp;
          checkShift();
        }
        break;
        ...
        if (rtDW.autoXCounter_dc <= 1) {
          if ((rtDW.RateTransition29[0] != rtDW.lastAutoXCom) &&
            ...
            if (rtDW.is_ACTIVE_d != IN_RELEASE) {
              ...
              MODESACCELERATION_PIDLAUN_n(rtM, (real_T)rtDW.RateTransition36[3],
                (real_T)rtDW.RateTransition36[4], &Saturation4_a,
                &rtDW.MODESACCELERATION_PIDLAUNCH5ACT);

              /* End of Outputs for SubSystem: '<S48>/MODES.ACCELERATION_PID.LAUNCH5.ACTIVE.ramp' */
              if (Saturation4_a < 256.0) {
                if (Saturation4_a >= 0.0) {
                  rtDW.clutchCurrVal = (uint8_T)Saturation4_a;
                } else {
                  rtDW.clutchCurrVal = 0U;
                }
              } else {
          ...
          tmp = rtDW.autoXCounter_dc - 1;
          if (tmp < 0) {
            tmp = 0;
          }

          rtDW.autoXCounter_dc = (uint16_T)tmp;
          checkShift();
        }
        break;
      ...
      switch (rtDW.is_ACTIVE_gc) {
       case IN_READY:
        if (rtDW.autoXCounter_e <= 1) {
          if ((rtDW.RateTransition29[0] != rtDW.lastAutoXCom) &&
            ...
            rtDW.stateFb = (uint16_T)AUTOX_GO;
            rtDW.is_ACTIVE_gc = 0;
            if (rtDW.is_ACTIVE_gc != IN_RELEASE) {
              rtDW.is_ACTIVE_gc = IN_RELEASE;
              rtDW.lastSlip = 0U;
            ...
            rtDW.is_ACTIVE_gc = 0;
            if (rtDW.is_ACTIVE_gc != IN_READY) {
              rtDW.is_ACTIVE_gc = IN_READY;
              rtDW.stateFb = (uint16_T)AUTOX_READY;
              rtDW.autoXCounter_e = AUTOX_WORK_RATE_ms;
              Clutch_setValue(55);
              checkShift();
       ...
       case IN_RELEASE:
        if (rtDW.RateTransition36[1] >= RELEASE_END_SPEED) {
          ...
          rtDW.is_RELEASE = 0;
          rtDW.is_ACTIVE_gc = 0;
          if (rtDW.is_ACTIVE_gc != IN_RUNNING) {
            rtDW.is_ACTIVE_gc = IN_RUNNING;
            rtDW.autoXCounter_e = AUTOX_WORK_RATE_ms;
            tmp_0 = rtDW.RateTransition36[6];
            if (rtDW.RateTransition36[6] > 255) {
              tmp_0 = 255U;
       ...
       case IN_READY:
        if (rtDW.autoXCounter_fg <= 1) {
          if ((rtDW.RateTransition29[0] != rtDW.lastAutoXCom) &&
            ...
            rtDW.stateFb = (uint16_T)AUTOX_GO;
            rtDW.is_ACTIVE_m = 0;
            if (rtDW.is_ACTIVE_m != IN_RELEASE) {
              rtDW.is_ACTIVE_m = IN_RELEASE;
              rtDW.lastSlip_b = 0U;
          ...
          tmp = rtDW.autoXCounter_fg - 1;
          if (tmp < 0) {
            tmp = 0;
          }

          rtDW.autoXCounter_fg = (uint16_T)tmp;
          checkShift();
        }
        break;
       ...
       case IN_RELEASE:
        if (rtDW.RateTransition36[1] >= RELEASE_END_SPEED) {
          ...
          switch (rtDW.is_RELEASE_i) {
           ...
           case IN_WAIT:
            if (rtDW.RateTransition34 != rtDW.lastSlip_b) {
              rtDW.lastSlip_b = rtDW.RateTransition34;
              rtDW.is_RELEASE_i = 0;
     ...
     case IN_LAUNCH:
      switch (rtDW.is_LAUNCH) {
           ...
           case IN_READY:
            if (rtDW.autoXCounter <= 1) {
              if ((rtDW.RateTransition29[0] != rtDW.lastAutoXCom) &&
                ...
                rtDW.lastAutoXCom = rtDW.RateTransition29[0];
                rtDW.is_ACTIVE_h = 0;
                if (rtDW.is_ACTIVE_h != IN_START_RELEASE) {
                  rtDW.is_ACTIVE_h = IN_START_RELEASE;
                  rtDW.stateFb = (uint16_T)AUTOX_GO;
           ...
           case IN_RELEASING:
            if (rtDW.autoXCounter <= 1) {
              if ((rtDW.autoX_dtRelease <= 0) || (rtDW.clutchCurrVal <=
                ...
                rtDW.is_ACTIVE_h = 0;
                if (rtDW.is_ACTIVE_h != IN_RELEASING) {
                  rtDW.is_ACTIVE_h = IN_RELEASING;
       ...
       case IN_STOPPING:
        rtDW.is_LAUNCH = 0;
        rtDW.is_AUTOCROSS = 0;
        if (rtDW.is_AUTOCROSS != IN_DEFAULT_a) {
          rtDW.is_AUTOCROSS = IN_DEFAULT_a;
          rtDW.stateFb = (uint16_T)AUTOX_DEFAULT;
          checkShift();
          checkClutch();
        }
...
void GCU_Model_genCode_step1(void)     /* Sample time: [0.001s, 0.0s] */
{
  ...
  if (rtDW.is_active_c1_GCU_Model_genCode == 0U) {
    ...
    rtDW.is_START_ENGINE = IN_WAIT_p;
