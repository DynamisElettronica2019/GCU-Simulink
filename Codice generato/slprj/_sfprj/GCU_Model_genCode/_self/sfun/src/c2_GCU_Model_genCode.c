  ...
  *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c2_STOP_COM, 19U);
  chartInstance->c2_b_STOP_COM = 0U;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c2_b_STOP_COM, 23U);
  chartInstance->c2_GEAR_COMMAND_NEUTRAL_DOWN = 100U;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c2_GEAR_COMMAND_NEUTRAL_DOWN, 21U);
  chartInstance->c2_GEAR_COMMAND_NEUTRAL_UP = 50U;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c2_GEAR_COMMAND_NEUTRAL_UP, 22U);
  chartInstance->c2_GEAR_COMMAND_DOWN = 200U;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c2_GEAR_COMMAND_DOWN, 20U);
  chartInstance->c2_c_STOP_COM = 0U;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c2_c_STOP_COM, 25U);
  chartInstance->c2_ACC_CLUTCH_NOISE_LEVEL = 30U;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c2_ACC_CLUTCH_NOISE_LEVEL, 24U);
  chartInstance->c2_d_STOP_COM = 0U;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c2_d_STOP_COM, 26U);
  chartInstance->c2_e_STOP_COM = 0U;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c2_e_STOP_COM, 27U);
  ...
  (SFc2_GCU_Model_genCodeInstanceStruct *chartInstance)
{
  ...
  c2_f_y = NULL;
  sf_mex_assign(&c2_f_y, sf_mex_create("y", &c2_c_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c2_y, 4, c2_f_y);
  c2_d_hoistedGlobal = *chartInstance->c2_currGear;
  c2_g_y = NULL;
  sf_mex_assign(&c2_g_y, sf_mex_create("y", &c2_d_hoistedGlobal, 5, 0U, 0U, 0U,
    0), false);
  ...
  c2_j_y = NULL;
  sf_mex_assign(&c2_j_y, sf_mex_create("y", &c2_f_hoistedGlobal, 0, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c2_y, 8, c2_j_y);
  c2_g_hoistedGlobal = *chartInstance->c2_rpmLimiterTarget;
  c2_k_y = NULL;
  sf_mex_assign(&c2_k_y, sf_mex_create("y", &c2_g_hoistedGlobal, 5, 0U, 0U, 0U,
    0), false);
  ...
  c2_h_hoistedGlobal = *chartInstance->c2_startEngCommand;
  c2_m_y = NULL;
  sf_mex_assign(&c2_m_y, sf_mex_create("y", &c2_h_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c2_y, 11, c2_m_y);
  c2_i_hoistedGlobal = *chartInstance->c2_tractionTarget;
  c2_n_y = NULL;
  ...
  (SFc2_GCU_Model_genCodeInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  *chartInstance->c2_clutchTarget = c2_h_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_u, 4)), "clutchTarget");
  ...
  *chartInstance->c2_tractionTarget = c2_d_emlrt_marshallIn(chartInstance,
  ...
  chartInstance->c2_is_active_c2_GCU_Model_genCode = c2_h_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 13)),
    ...
    *chartInstance->c2_acc_externValue = *chartInstance->c2_thirdInt;
    ...
    if (c2_c_out) {
      ...
      if (c2_f_out) {
        ...
        *chartInstance->c2_startEngCommand = (uint8_T)c2_i12;
        _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c2_startEngCommand, 11U);
      }
  ...
  *chartInstance, uint16_T c2_com)
{
  ...
  boolean_T c2_b_temp;
  boolean_T c2_d_out;
  _SFD_DATA_RANGE_CHECK((real_T)c2_com, 28U);
  _SFD_SET_DATA_VALUE_PTR(28U, (void *)&c2_com);
  ...
  if (c2_b_out) {
    ...
    for (c2_i19 = 0; c2_i19 < 2; c2_i19++) {
      _SFD_DATA_RANGE_CHECK((real_T)(*chartInstance->c2_shiftCommand)[c2_i19],
                            10U);
    }
    ...
    c2_i18 = (*chartInstance->c2_shiftCommand)[0] + 1;
    c2_covSaturation = false;
    if (c2_i18 < 0) {
      c2_covSaturation = true;
      c2_i18 = 0;
    ...
    (*chartInstance->c2_shiftCommand)[0] = (uint16_T)c2_i18;
  ...
  for (c2_i21 = 0; c2_i21 < 2; c2_i21++) {
    _SFD_DATA_RANGE_CHECK((real_T)(*chartInstance->c2_shiftCommand)[c2_i21], 10U);
  }
  ...
  *chartInstance, uint16_T c2_com)
{
  ...
  if (c2_b_out) {
    ...
    for (c2_i23 = 0; c2_i23 < 2; c2_i23++) {
      _SFD_DATA_RANGE_CHECK((real_T)(*chartInstance->c2_accCommand)[c2_i23], 12U);
    }

    c2_u9 = (*chartInstance->c2_accCommand)[0];
    sf_mex_printf("%s =\\n", "accCommand[0]");
    ...
    c2_i22 = (*chartInstance->c2_accCommand)[0] + 1;
    c2_covSaturation = false;
    if (c2_i22 < 0) {
      c2_covSaturation = true;
      c2_i22 = 0;
    ...
    (*chartInstance->c2_accCommand)[0] = (uint16_T)c2_i22;
  ...
  c2_u11 = (*chartInstance->c2_accCommand)[1];
  sf_mex_printf("%s =\\n", "accCommand[1]");
  ...
  *chartInstance, uint16_T c2_com)
{
  ...
  if (c2_b_out) {
    ...
    for (c2_i27 = 0; c2_i27 < 2; c2_i27++) {
      _SFD_DATA_RANGE_CHECK((real_T)(*chartInstance->c2_autoXCommand)[c2_i27],
                            18U);
    }

    c2_u12 = (*chartInstance->c2_autoXCommand)[0];
    sf_mex_printf("%s =\\n", "autoXCommand[0]");
    ...
    c2_i26 = (*chartInstance->c2_autoXCommand)[0] + 1;
    c2_covSaturation = false;
    if (c2_i26 < 0) {
      c2_covSaturation = true;
      c2_i26 = 0;
    ...
    (*chartInstance->c2_autoXCommand)[0] = (uint16_T)c2_i26;
  ...
  for (c2_i29 = 0; c2_i29 < 2; c2_i29++) {
    _SFD_DATA_RANGE_CHECK((real_T)(*chartInstance->c2_autoXCommand)[c2_i29], 18U);
  }

  c2_u14 = (*chartInstance->c2_autoXCommand)[1];
  sf_mex_printf("%s =\\n", "autoXCommand[1]");
  ...
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId)
{
  ...
  uint16_T c2_u15;
  (void)chartInstance;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), &c2_u15, 1, 5, 0U, 0, 0U, 0);
  c2_y = c2_u15;
  sf_mex_destroy(&c2_u);
  return c2_y;
}
  ...
  *c2_inData)
{
  ...
  for (c2_i31 = 0; c2_i31 < 2; c2_i31++) {
    c2_u[c2_i31] = (*(uint16_T (*)[2])c2_inData)[c2_i31];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  for (c2_i33 = 0; c2_i33 < 2; c2_i33++) {
    (*(uint16_T (*)[2])c2_outData)[c2_i33] = c2_y[c2_i33];
  }
  ...
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId)
{
  ...
  uint8_T c2_u16;
  (void)chartInstance;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), &c2_u16, 1, 3, 0U, 0, 0U, 0);
  c2_y = c2_u16;
  sf_mex_destroy(&c2_u);
  return c2_y;
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2569078422U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2417860778U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4229686568U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1953549741U);
}
...
mxArray *sf_c2_GCU_Model_genCode_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("9zYePWaakhKB4QRXNw469C");
...
static const mxArray *sf_get_sim_state_info_c2_GCU_Model_genCode(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[162],T\"accCommand\",},{M[1],M[104],T\"acc_externValue\",},{M[1],M[103],T\"acc_externValues_index\",},{M[1],M[611],T\"autoXCommand\",},{M[1],M[184],T\"clutchTarget\",},{M[1],M[102],T\"currGear\",},{M[1],M[373],T\"mapTarget\",},{M[1],M[337],T\"modeCommand\",},{M[1],M[94],T\"out\",},{M[1],M[583],T\"rpmLimiterTarget\",}}",
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[131],T\"shiftCommand\",},{M[1],M[161],T\"startEngCommand\",},{M[1],M[183],T\"tractionTarget\",},{M[8],M[0],T\"is_active_c2_GCU_Model_genCode\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(19,7,0,0,"STOP_COM");
          _SFD_SET_DATA_PROPS(20,7,0,0,"GEAR_COMMAND_DOWN");
          _SFD_SET_DATA_PROPS(21,7,0,0,"GEAR_COMMAND_NEUTRAL_DOWN");
          _SFD_SET_DATA_PROPS(22,7,0,0,"GEAR_COMMAND_NEUTRAL_UP");
          _SFD_SET_DATA_PROPS(23,7,0,0,"STOP_COM");
          _SFD_SET_DATA_PROPS(24,7,0,0,"ACC_CLUTCH_NOISE_LEVEL");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S)) {
      /* do this only if simulation is starting and after we know the addresses of all data */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(19U, (void *)&chartInstance->c2_STOP_COM);
        _SFD_SET_DATA_VALUE_PTR(23U, (void *)&chartInstance->c2_b_STOP_COM);
        ...
        _SFD_SET_DATA_VALUE_PTR(25U, (void *)&chartInstance->c2_c_STOP_COM);
        _SFD_SET_DATA_VALUE_PTR(24U, (void *)
          &chartInstance->c2_ACC_CLUTCH_NOISE_LEVEL);
        _SFD_SET_DATA_VALUE_PTR(26U, (void *)&chartInstance->c2_d_STOP_COM);
        _SFD_SET_DATA_VALUE_PTR(27U, (void *)&chartInstance->c2_e_STOP_COM);
      }
    }
  }
}
...
{
  return "slmuX1x1lisk6NXgVWZpz8C";
}
...
static void mdlSetWorkWidths_c2_GCU_Model_genCode(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1716385326U));
  ssSetChecksum1(S,(2260299859U));
  ssSetChecksum2(S,(3344299226U));
  ssSetChecksum3(S,(2682828148U));
