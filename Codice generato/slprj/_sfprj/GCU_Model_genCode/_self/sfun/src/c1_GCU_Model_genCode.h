...
typedef struct {
  ...
  uint16_T c1_c_GEAR_COMMAND_NEUTRAL_UP;
  uint16_T c1_c_GEAR_COMMAND_NEUTRAL_DOWN;
  uint16_T c1_c_GEAR_COMMAND_UP;
  uint16_T c1_c_GEAR_COMMAND_DOWN;
  real_T c1_RETRY_DELAY;
  uint16_T c1_lastShiftChecked;
  ...
  uint8_T c1_sdiLoggedDataBuffer[208];
