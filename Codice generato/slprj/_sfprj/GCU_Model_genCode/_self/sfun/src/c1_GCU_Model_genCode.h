...
typedef struct {
  ...
  uint16_T c1_GEAR_COMMAND_DOWN1;
  uint16_T c1_GEAR_COMMAND_UP1;
  ...
  uint8_T c1_sdiLoggedStatesBuffer[167];
  uint8_T c1_sdiLoggedDataBuffer[207];
  ...
  SignalExportStruct c1_rj_SignalExportProp;
  SignalExportStruct c1_sj_SignalExportProp;
