...
MdlrefDW_GCU_CAN_T GCU_CAN_MdlrefDW;

/* Block states (default storage) */
DW_GCU_CAN_f_T GCU_CAN_DW;
  ...
  rty_aacCommand[2], uint8_T rty_clutchCommand[2], uint32_T *rty_tractionValue)
{
  ...
  *aac_externValues_index = (uint16_T)WHEEL_SPEED;
  if (GCU_CAN_DW.UnpackCanUart_o1 == GCU_CA_EFI_GEAR_RPM_TPS_APPS_ID) {
    GCU_CAN_DW.is_c3_GCU_CAN = GCU_CAN_IN_GEAR_RPM_UPDATE;
    *rty_currGear = GCU_CAN_DW.UnpackCanUart_o2;
    *aac_externValues_index = (uint16_T)RPM;
    *aac_externValue = GCU_CAN_DW.UnpackCanUart_o3;
    ...
    GCU_CAN_AAC_ExternalValues(*aac_externValue, *aac_externValues_index,
      rty_aac_externValue, &GCU_CAN_DW.AAC_ExternalValues);
  } else if (GCU_CAN_DW.UnpackCanUart_o1 == GCU_CAN_SW_FIRE_GCU_ID) {
    GCU_CAN_DW.is_c3_GCU_CAN = GCU_CAN_IN_START_ENGINE;
    GCU_CAN_sendStartEngCommand(rty_startEngCommand);
  } else if (GCU_CAN_DW.UnpackCanUart_o1 == GCU_CAN_SW_GEARSHIFT_ID) {
    GCU_CAN_DW.is_c3_GCU_CAN = GCU_CAN_IN_SW_GEARSHIFT;
    if ((GCU_CAN_DW.UnpackCanUart_o2 != GCU_CAN_RPM_LIMITER_ON) &&
        (GCU_CAN_DW.UnpackCanUart_o2 != GCU_CAN_RPM_LIMITER_OFF)) {
      GCU_CAN_sendShiftCommand(GCU_CAN_DW.UnpackCanUart_o2, rtu_clutchCurrVal,
        rty_shiftCommand, rty_aacCommand);
    }
  } else if (GCU_CAN_DW.UnpackCanUart_o1 == GCU_CAN_EFI_TRACTION_CONTROL_ID) {
    GCU_CAN_DW.is_c3_GCU_CAN = GCU_CAN_IN_WHEEL_SPEED_UPDATE;
    *aac_externValues_index = (uint16_T)WHEEL_SPEED;
    *aac_externValue = (uint16_T)rt_roundd((real_T)GCU_CAN_DW.UnpackCanUart_o2 /
      10.0);
    ...
    GCU_CAN_AAC_ExternalValues(*aac_externValue, *aac_externValues_index,
      rty_aac_externValue, &GCU_CAN_DW.AAC_ExternalValues);
  } else if (GCU_CAN_DW.UnpackCanUart_o1 == GCU_CAN_SW_CLUTCH_TARGET_GCU_ID) {
    GCU_CAN_DW.is_c3_GCU_CAN = GCU_CAN_IN_SET_CLUTCH;
    clutchSetVal = (uint8_T)((uint32_T)GCU_CAN_DW.UnpackCanUart_o2 >> 8);
    if (clutchSetVal > GCU_CAN_AAC_CLUTCH_NOISE_LEVEL) {
      GCU_CAN_sendAacCommand(GCU_CAN_STOP_COM, rty_aacCommand);
    }

    GCU_CAN_sendClutchCommand(clutchSetVal, rty_clutchCommand);
  } else if (GCU_CAN_DW.UnpackCanUart_o1 == GCU_CAN_SW_ACCELERATION_GCU_ID) {
    GCU_CAN_DW.is_c3_GCU_CAN = GCU_CAN_IN_AAC_COM;
    GCU_CAN_sendAacCommand(GCU_CAN_DW.UnpackCanUart_o2, rty_aacCommand);
    if (rty_aacCommand[1] == GCU_CAN_STOP_COM) {
      GCU_CAN_sendClutchCommand(0, rty_clutchCommand);
    }
  } else if (GCU_CAN_DW.UnpackCanUart_o1 == GCU__SW_TRACTION_CONTROL_GCU_ID) {
    GCU_CAN_DW.is_c3_GCU_CAN = GCU_CAN_IN_SET_TRACTION;
    *tractionValue = GCU_CAN_DW.UnpackCanUart_o2 * 100U;

    /* Chart: '<Root>/MessageEvaluation' incorporates:
     *  SubSystem: '<Root>/TractionValue'
     */
    GCU_CAN_TractionValue(*tractionValue, rty_tractionValue,
                          &GCU_CAN_DW.TractionValue);
  } else {
    GCU_CAN_DW.is_c3_GCU_CAN = GCU_CAN_IN_IDLE;
  }
}
             ...
             *rty_tractionValue)
{
  ...
  UnpackCanUART_Outputs_wrapper(&rtu_dataBuffer[0], &GCU_CAN_DW.UnpackCanUart_o1,
    &GCU_CAN_DW.UnpackCanUart_o2, &GCU_CAN_DW.UnpackCanUart_o3,
    &GCU_CAN_DW.UnpackCanUart_o4, &GCU_CAN_DW.UnpackCanUart_o5);

  /* Chart: '<Root>/MessageEvaluation' */
  if (GCU_CAN_DW.is_active_c3_GCU_CAN == 0U) {
    GCU_CAN_DW.is_active_c3_GCU_CAN = 1U;
    GCU_CAN_DW.is_c3_GCU_CAN = GCU_CAN_IN_IDLE;
  } else {
    switch (GCU_CAN_DW.is_c3_GCU_CAN) {
     case GCU_CAN_IN_AAC_COM:
      GCU_CAN_AAC_COM(&aac_externValue, &aac_externValues_index, &tractionValue,
                      ...
                      rty_clutchCommand, rty_tractionValue);
      break;
     ...
     case GCU_CAN_IN_IDLE:
      if (GCU_CAN_DW.UnpackCanUart_o1 == GCU_CA_EFI_GEAR_RPM_TPS_APPS_ID) {
        ...
        *rty_currGear = GCU_CAN_DW.UnpackCanUart_o2;
        ...
        GCU_CAN_AAC_ExternalValues(GCU_CAN_DW.UnpackCanUart_o3, (uint16_T)RPM,
          rty_aac_externValue, &GCU_CAN_DW.AAC_ExternalValues);
        ...
        if ((GCU_CAN_DW.UnpackCanUart_o2 != GCU_CAN_RPM_LIMITER_ON) &&
            (GCU_CAN_DW.UnpackCanUart_o2 != GCU_CAN_RPM_LIMITER_OFF)) {
          GCU_CAN_sendShiftCommand(GCU_CAN_DW.UnpackCanUart_o2,
            rtu_clutchCurrVal, rty_shiftCommand, rty_aacCommand);
        }
      } else if (GCU_CAN_DW.UnpackCanUart_o1 == GCU_CAN_EFI_TRACTION_CONTROL_ID)
      {
        GCU_CAN_DW.is_c3_GCU_CAN = GCU_CAN_IN_WHEEL_SPEED_UPDATE;
        ...
        GCU_CAN_AAC_ExternalValues((uint16_T)rt_roundd((real_T)
          GCU_CAN_DW.UnpackCanUart_o2 / 10.0), (uint16_T)WHEEL_SPEED,
          rty_aac_externValue, &GCU_CAN_DW.AAC_ExternalValues);
      ...
      } else if (GCU_CAN_DW.UnpackCanUart_o1 == GCU__SW_TRACTION_CONTROL_GCU_ID)
      {
        ...
        GCU_CAN_TractionValue(GCU_CAN_DW.UnpackCanUart_o2 * 100U,
                              rty_tractionValue, &GCU_CAN_DW.TractionValue);
...
void GCU_CAN_initialize(const char_T **rt_errorStatus)
{
  RT_MODEL_GCU_CAN_T *const GCU_CAN_M = &(GCU_CAN_MdlrefDW.rtm);
