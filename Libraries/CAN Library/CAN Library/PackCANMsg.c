 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sat Apr 20 15:20:26 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME PackCANMsg
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            4
/* Input Port  0 */
#define IN_PORT_0_NAME        firstInt
...
/* Input Port  1 */
#define IN_PORT_1_NAME        secondInt
...
/* Input Port  2 */
#define IN_PORT_2_NAME        thirdInt
...
/* Input Port  3 */
#define IN_PORT_3_NAME        fourthInt
...
/* Output Port  0 */
#define OUT_PORT_0_NAME       dataArray
...
{
    const uint16_T *firstInt = (uint16_T *) ssGetInputPortRealSignal(S, 0);
    const uint16_T *secondInt = (uint16_T *) ssGetInputPortRealSignal(S, 1);
    const uint16_T *thirdInt = (uint16_T *) ssGetInputPortRealSignal(S, 2);
    const uint16_T *fourthInt = (uint16_T *) ssGetInputPortRealSignal(S, 3);
    uint8_T *dataArray = (uint8_T *) ssGetOutputPortRealSignal(S, 0);

    PackCANMsg_Outputs_wrapper(firstInt, secondInt, thirdInt, fourthInt, dataArray);
