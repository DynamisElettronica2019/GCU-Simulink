 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sat Apr 27 11:17:39 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME PackCanUART
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Input Port  1 */
#define IN_PORT_1_NAME        firstInt
...
/* Input Port  2 */
#define IN_PORT_2_NAME        secondInt
...
/* Input Port  3 */
#define IN_PORT_3_NAME        thirdInt
...
/* Input Port  4 */
#define IN_PORT_4_NAME        fourthInt
...
/* Output Port  0 */
#define OUT_PORT_0_NAME       message
...
{
    const uint16_T *id = (uint16_T *) ssGetInputPortRealSignal(S, 0);
    const uint16_T *firstInt = (uint16_T *) ssGetInputPortRealSignal(S, 1);
    const uint16_T *secondInt = (uint16_T *) ssGetInputPortRealSignal(S, 2);
    const uint16_T *thirdInt = (uint16_T *) ssGetInputPortRealSignal(S, 3);
    const uint16_T *fourthInt = (uint16_T *) ssGetInputPortRealSignal(S, 4);
    uint8_T *message = (uint8_T *) ssGetOutputPortRealSignal(S, 0);

    PackCanUART_Outputs_wrapper(id, firstInt, secondInt, thirdInt, fourthInt, message);
