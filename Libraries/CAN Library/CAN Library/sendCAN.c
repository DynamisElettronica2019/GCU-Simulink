 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu May 09 12:02:40 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sendCAN
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Input Port  1 */
#define IN_PORT_1_NAME        dataArray
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const uint8_T *dataArray = (uint8_T *) ssGetInputPortRealSignal(S, 1);

    sendCAN_Outputs_wrapper(id, dataArray);
