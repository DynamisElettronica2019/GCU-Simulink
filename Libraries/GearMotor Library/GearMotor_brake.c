 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu Apr 25 16:08:23 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME GearMotor_brake
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    GearMotor_brake_Outputs_wrapper(GearMotor_In1, GearMotor_In2, GearMotor_INH);
