 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon Apr 29 10:46:51 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME writeValueEEPROM
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const uint16_T *value = (uint16_T *) ssGetInputPortRealSignal(S, 1);

    writeValueEEPROM_Outputs_wrapper(address, value);
