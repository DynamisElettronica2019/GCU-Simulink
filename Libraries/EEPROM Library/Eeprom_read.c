 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed May 22 09:33:25 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Eeprom_read
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  0 */
#define OUT_PORT_0_NAME       resRead
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    uint8_T *resRead = (uint8_T *) ssGetOutputPortRealSignal(S, 0);
    uint8_T *data = (uint8_T *) ssGetOutputPortRealSignal(S, 1);

    Eeprom_read_Outputs_wrapper(page, cell, dataSize, resRead, data);
