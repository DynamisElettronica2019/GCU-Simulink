...
#define S_FUNCTION_NAME load_autoXParameters
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
{
    int32_T *autoXParameters = (int32_T *) ssGetOutputPortRealSignal(S, 0);

    load_autoXParameters_Outputs_wrapper(autoXParameters);
