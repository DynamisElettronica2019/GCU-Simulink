 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Apr 19 11:30:19 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME update_ADC_data
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
{
    const uint32_T *adc_buffer = (uint32_T *) ssGetInputPortRealSignal(S, 0);
    uint32_T *adc_data_vector = (uint32_T *) ssGetOutputPortRealSignal(S, 0);

    update_ADC_data_Outputs_wrapper(adc_buffer, adc_data_vector);
