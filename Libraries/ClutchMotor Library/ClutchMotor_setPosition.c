/*
 * File: ClutchMotor_setPosition.c
 *
 *
 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Jan 29 11:58:50 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME ClutchMotor_setPosition
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
{
    const uint8_T *percentage = (uint8_T *) ssGetInputPortRealSignal(S, 0);
