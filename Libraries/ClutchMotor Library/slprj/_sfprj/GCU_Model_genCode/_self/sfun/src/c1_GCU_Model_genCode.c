...
static uint8_T c1_c_emlrt_marshallIn(SFc1_GCU_Model_genCodeInstanceStruct
  *chartInstance, const mxArray *c1_b_tp_SCAN_ADC, const char_T *c1_identifier);
...
static void c1_sdiInitialize(SFc1_GCU_Model_genCodeInstanceStruct *chartInstance)
{
  ...
  uint32_T c1_c[55] = { 4U, 123U, 834U, 443U, 485U, 524U, 579U, 680U, 715U, 799U,
    833U, 837U, 925U, 938U, 627U, 628U, 629U, 630U, 681U, 684U, 643U, 644U, 645U,
    646U, 631U, 632U, 633U, 634U, 537U, 550U, 561U, 563U, 564U, 698U, 699U, 700U,
    702U, 704U, 705U, 706U, 707U, 708U, 709U, 710U, 754U, 568U, 569U, 751U, 753U,
    45U, 437U, 164U, 501U, 484U, 488U };
  ...
  sdi_database_initialize(&chartInstance->c1_sdiBlockInfo, c1_b, (uint8_T *)
    ...
    &chartInstance->c1_sdiLoggedDataBuffer[0U], 55);
  ...
  if (chartInstance->c1_sdiLoggedDataBuffer[29U]) {
    sdi_register_builtin_data_type_signal(&chartInstance->c1_sdiBlockInfo,
      "aacCounter", "MODES/ACCELERATION/ACC", 1, c1_ad, 1, 5, 0, 0,
  ...
  if (chartInstance->c1_sdiLoggedDataBuffer[30U]) {
    sdi_register_builtin_data_type_signal(&chartInstance->c1_sdiBlockInfo,
      "aac_clutchValue", "MODES/ACCELERATION/ACC", 1, c1_bd, 1, 0, 0, 0,
  ...
  if (chartInstance->c1_sdiLoggedDataBuffer[31U]) {
    sdi_register_builtin_data_type_signal(&chartInstance->c1_sdiBlockInfo,
      "aac_clutchStep", "MODES/ACCELERATION/ACC", 1, c1_cd, 1, 0, 0, 0,
  ...
  if (chartInstance->c1_sdiLoggedDataBuffer[32U]) {
    sdi_register_builtin_data_type_signal(&chartInstance->c1_sdiBlockInfo,
      "aac_dtRelease", "MODES/ACCELERATION/ACC", 1, c1_dd, 1, 6, 0, 0,
  ...
  *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_START_AAC_COM, 25U);
  chartInstance->c1_RELEASE_AAC_COM = 2U;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_RELEASE_AAC_COM, 24U);
  chartInstance->c1_STOP_AAC_COM = 0U;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_STOP_AAC_COM, 26U);
  chartInstance->c1_GEAR_COMMAND_NEUTRAL_UP = 50U;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_GEAR_COMMAND_NEUTRAL_UP, 29U);
  chartInstance->c1_GEAR_COMMAND_NEUTRAL_DOWN = 100U;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_GEAR_COMMAND_NEUTRAL_DOWN, 28U);
  chartInstance->c1_GEAR_COMMAND_UP = 400U;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_GEAR_COMMAND_UP, 30U);
  chartInstance->c1_GEAR_COMMAND_DOWN = 200U;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_GEAR_COMMAND_DOWN, 27U);
  chartInstance->c1_b_GEAR_COMMAND_NEUTRAL_UP = 50U;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_b_GEAR_COMMAND_NEUTRAL_UP, 33U);
  ...
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_b_GEAR_COMMAND_UP, 34U);
  chartInstance->c1_b_GEAR_COMMAND_DOWN = 200U;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_b_GEAR_COMMAND_DOWN, 31U);
  chartInstance->c1_AAC_WORK_RATE_ms = 25U;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_AAC_WORK_RATE_ms, 35U);
  chartInstance->c1_DEF_RAMP_START = 50;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_DEF_RAMP_START, 38U);
  chartInstance->c1_DEF_RAMP_END = 0;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_DEF_RAMP_END, 37U);
  chartInstance->c1_DEF_RAMP_TIME = 250;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_DEF_RAMP_TIME, 39U);
  chartInstance->c1_DEF_RPM_LIMIT_1_2 = 11000;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_DEF_RPM_LIMIT_1_2, 40U);
  chartInstance->c1_DEF_RPM_LIMIT_2_3 = 11000;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_DEF_RPM_LIMIT_2_3, 41U);
  chartInstance->c1_DEF_RPM_LIMIT_3_4 = 11000;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_DEF_RPM_LIMIT_3_4, 42U);
  chartInstance->c1_DEF_RPM_LIMIT_4_5 = 11000;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_DEF_RPM_LIMIT_4_5, 43U);
  chartInstance->c1_DEF_SPEED_LIMIT_1_2 = 46;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_DEF_SPEED_LIMIT_1_2, 44U);
  chartInstance->c1_DEF_SPEED_LIMIT_2_3 = 61;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_DEF_SPEED_LIMIT_2_3, 45U);
  chartInstance->c1_DEF_SPEED_LIMIT_3_4 = 77;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_DEF_SPEED_LIMIT_3_4, 46U);
  chartInstance->c1_DEF_SPEED_LIMIT_4_5 = 113;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_DEF_SPEED_LIMIT_4_5, 47U);
  chartInstance->c1_ACC_CODE = 1U;
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_ACC_CODE, 36U);
  chartInstance->c1_data = 0.0;
  _SFD_DATA_RANGE_CHECK(chartInstance->c1_data, 48U);
  ...
  (SFc1_GCU_Model_genCodeInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_tp_GEARSHIFT = 1U;
  chartInstance->c1_ticksCounter = 0;
  c1_d_sdiStreamingWrapperFcn(chartInstance, 0, 49, 45U, (void *)
  ...
  chartInstance->c1_tp_START_ENGINE = 1U;
  chartInstance->c1_lastCom = 0U;
  c1_d_sdiStreamingWrapperFcn(chartInstance, 0, 53, 484U, (void *)
    &chartInstance->c1_lastCom);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c1_lastCom, 9U);
  chartInstance->c1_startCounter = 0U;
  c1_d_sdiStreamingWrapperFcn(chartInstance, 0, 54, 488U, (void *)
...
static void c1_START_ENGINE(SFc1_GCU_Model_genCodeInstanceStruct *chartInstance)
{
  ...
  switch (chartInstance->c1_is_START_ENGINE) {
   ...
   case c1_b_IN_WAIT:
    CV_STATE_EVAL(58, 0, c1_b_IN_WAIT);
  ...
  *chartInstance, c1_aac_params c1_index)
{
  int32_T c1_param;
  int32_T c1_b_param;
  _SFD_SET_DATA_VALUE_PTR(54U, (void *)&c1_param);
  _SFD_SET_DATA_VALUE_PTR(51U, (void *)&c1_index);
  ...
  c1_param = 0;
  _SFD_DATA_RANGE_CHECK((real_T)c1_param, 54U);
...
static void c1_sendUpdatesSW(SFc1_GCU_Model_genCodeInstanceStruct *chartInstance,
  uint16_T c1_b_valCode, uint16_T c1_b_value)
{
  _SFD_SET_DATA_VALUE_PTR(52U, (void *)&c1_b_value);
  _SFD_SET_DATA_VALUE_PTR(50U, (void *)&c1_b_valCode);
  ...
  *chartInstance)
{
  ...
  int32_T c1_f_time;
  int32_T c1_g_time;
  _SFD_SET_DATA_VALUE_PTR(53U, (void *)&c1_time);
  ...
  c1_time = 0;
  _SFD_DATA_RANGE_CHECK((real_T)c1_time, 53U);
...
static void c1_Clutch_setValue(SFc1_GCU_Model_genCodeInstanceStruct
  *chartInstance, uint8_T c1_setValue)
{
  _SFD_DATA_RANGE_CHECK((real_T)c1_setValue, 49U);
  _SFD_SET_DATA_VALUE_PTR(49U, (void *)&c1_setValue);
  ...
  *chartInstance, const mxArray *c1_b_tp_SCAN_ADC, const char_T *c1_identifier)
{
  ...
  c1_thisId.fParent = NULL;
  c1_thisId.bParentIsCell = false;
  c1_y = c1_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_b_tp_SCAN_ADC),
    &c1_thisId);
  sf_mex_destroy(&c1_b_tp_SCAN_ADC);
  return c1_y;
}
...
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  const mxArray *c1_b_tp_SCAN_ADC;
  const char_T *c1_identifier;
  emlrtMsgIdentifier c1_thisId;
  uint8_T c1_y;
  SFc1_GCU_Model_genCodeInstanceStruct *chartInstance;
  chartInstance = (SFc1_GCU_Model_genCodeInstanceStruct *)chartInstanceVoid;
  c1_b_tp_SCAN_ADC = sf_mex_dup(c1_mxArrayInData);
  c1_identifier = c1_varName;
  c1_thisId.fIdentifier = (const char *)c1_identifier;
  c1_thisId.fParent = NULL;
  c1_thisId.bParentIsCell = false;
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(175686950U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3340715585U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3178348917U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1541639947U);
}
...
mxArray *sf_c1_GCU_Model_genCode_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("6mnfoo4z2l2BlDMWEp8yWC");
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(24,7,0,0,"RELEASE_AAC_COM");
          _SFD_SET_DATA_PROPS(25,7,0,0,"START_AAC_COM");
          _SFD_SET_DATA_PROPS(26,7,0,0,"STOP_AAC_COM");
          _SFD_SET_DATA_PROPS(27,7,0,0,"GEAR_COMMAND_DOWN");
          _SFD_SET_DATA_PROPS(28,7,0,0,"GEAR_COMMAND_NEUTRAL_DOWN");
          _SFD_SET_DATA_PROPS(29,7,0,0,"GEAR_COMMAND_NEUTRAL_UP");
          _SFD_SET_DATA_PROPS(30,7,0,0,"GEAR_COMMAND_UP");
          ...
          _SFD_SET_DATA_PROPS(35,7,0,0,"AAC_WORK_RATE_ms");
          _SFD_SET_DATA_PROPS(36,7,0,0,"ACC_CODE");
          _SFD_SET_DATA_PROPS(37,7,0,0,"DEF_RAMP_END");
          _SFD_SET_DATA_PROPS(38,7,0,0,"DEF_RAMP_START");
          _SFD_SET_DATA_PROPS(39,7,0,0,"DEF_RAMP_TIME");
          _SFD_SET_DATA_PROPS(40,7,0,0,"DEF_RPM_LIMIT_1_2");
          _SFD_SET_DATA_PROPS(41,7,0,0,"DEF_RPM_LIMIT_2_3");
          _SFD_SET_DATA_PROPS(42,7,0,0,"DEF_RPM_LIMIT_3_4");
          _SFD_SET_DATA_PROPS(43,7,0,0,"DEF_RPM_LIMIT_4_5");
          _SFD_SET_DATA_PROPS(44,7,0,0,"DEF_SPEED_LIMIT_1_2");
          _SFD_SET_DATA_PROPS(45,7,0,0,"DEF_SPEED_LIMIT_2_3");
          _SFD_SET_DATA_PROPS(46,7,0,0,"DEF_SPEED_LIMIT_3_4");
          _SFD_SET_DATA_PROPS(47,7,0,0,"DEF_SPEED_LIMIT_4_5");
          _SFD_SET_DATA_PROPS(48,7,0,0,"data");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S)) {
      /* do this only if simulation is starting and after we know the addresses of all data */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(25U, (void *)&chartInstance->c1_START_AAC_COM);
        _SFD_SET_DATA_VALUE_PTR(24U, (void *)&chartInstance->c1_RELEASE_AAC_COM);
        _SFD_SET_DATA_VALUE_PTR(26U, (void *)&chartInstance->c1_STOP_AAC_COM);
        ...
        _SFD_SET_DATA_VALUE_PTR(30U, (void *)&chartInstance->c1_GEAR_COMMAND_UP);
        ...
        _SFD_SET_DATA_VALUE_PTR(35U, (void *)&chartInstance->c1_AAC_WORK_RATE_ms);
        ...
        _SFD_SET_DATA_VALUE_PTR(38U, (void *)&chartInstance->c1_DEF_RAMP_START);
        _SFD_SET_DATA_VALUE_PTR(37U, (void *)&chartInstance->c1_DEF_RAMP_END);
        _SFD_SET_DATA_VALUE_PTR(39U, (void *)&chartInstance->c1_DEF_RAMP_TIME);
        ...
        _SFD_SET_DATA_VALUE_PTR(36U, (void *)&chartInstance->c1_ACC_CODE);
        _SFD_SET_DATA_VALUE_PTR(8U, (void *)&chartInstance->c1_ticksCounter);
        _SFD_SET_DATA_VALUE_PTR(48U, (void *)&chartInstance->c1_data);
...
{
  return "sJAaPetTX3AZuB7ZNIMhdVD";
}
...
static void mdlSetWorkWidths_c1_GCU_Model_genCode(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3887785604U));
  ssSetChecksum1(S,(2897222566U));
  ssSetChecksum2(S,(3322385325U));
  ssSetChecksum3(S,(1382654968U));
